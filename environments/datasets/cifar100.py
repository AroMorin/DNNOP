...
class CIFAR100(Dataset):
    def __init__(self, env_params):
        super(CIFAR100, self).__init__(env_params)
        env_params = self.ingest_params_lvl2(env_params)
        self.train_size = 50000 # Size of the training set
    ...
    def ingest_params_lvl2(self, env_params):
        ...
        default_params = {
                            "batch size": 50000  # Entire dataset
                            }
    ...
    def load_dataset(self):
        ...
        self.train_dataset = datasets.CIFAR10(self.data_path, train=True,
                                                    download=True,
